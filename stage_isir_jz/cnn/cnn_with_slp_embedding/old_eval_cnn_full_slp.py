...
if __name__ == "__main__":
    ...
    for member in unique_members:
        ...
        out_eval_dir = os.path.join(args.cnn_dir, f"old_spatial_eval_per_member/spatial_{split_name}_{args.model_type}_{freq_label}")
    ...
    for split in ['val', 'test']:
        ...
        out_eval_dir = os.path.join(args.cnn_dir, f"old_spatial_eval_per_member/spatial_{split}_{args.model_type}_{freq_label}")
